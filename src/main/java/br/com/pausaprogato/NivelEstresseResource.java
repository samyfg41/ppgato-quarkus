...
public class NivelEstresseResource {

    @POST
    public Response inserir(NivelEstresse obj) throws ClassNotFoundException, SQLException {
        RegistroDiarioBO bo = new RegistroDiarioBO();
        String msg = bo.inserirNivelEstresse(obj);
    ...
    @PUT
    @Path("/{id}")
    public Response atualizar(@PathParam("id") int id, NivelEstresse obj) throws ClassNotFoundException, SQLException {
        RegistroDiarioBO bo = new RegistroDiarioBO();
        obj.setId(id);
        String msg = bo.atualizarNivelEstresse(obj);
